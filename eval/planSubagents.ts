...
import { PLAN_LIMITS } from "../src/enterprise/agentPlan";
...
const provider: AgentModelProvider = { async generate(request) {
	...
	return { text: JSON.stringify(planning ? spec : { summary: "Fixed valid draft", evidence: ["synthetic-fixture"], limitations: ["No user or online-model validation"] }), toolCalls: [], usage: { inputTokens: 10, outputTokens: 10, cachedInputTokens: 0, reasoningOutputTokens: 0 } };
} };
